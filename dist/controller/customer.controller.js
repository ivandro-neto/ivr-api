...
const getCustomerBalance = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const message = `O saldo do cliente com número ${number} é de ${customer === null || customer === void 0 ? void 0 : customer.account_balance} kwanzas.`;
        // Gerando o áudio
        const filename = `balance_${number}_${Date.now()}.mp3`;
        yield generateAudio(message, `./public/audio/${filename}`);
        //@ts-ignore
